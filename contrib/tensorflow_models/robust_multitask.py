...
class RobustMultitaskClassifier(MultiTaskClassifier):
  ...
  def __init__(self,
    ...
    for i in range(num_layers):
      ...
      print(f"Adding weights of shape {[prev_layer_size, layer_sizes[i]]}")
      layer = tf.nn.relu(
    ...
    for _ in range(self.n_tasks):
      ...
      for i in range(num_bypass_layers):
        ...
        print(
            f"Adding bypass weights of shape {[prev_bypass_layer_size, bypass_layer_sizes[i]]}"
        )
      ...
      print(f"Adding output weights of shape {[task_layer_size, 1]}")
      output.append(
          model_ops.logits(
              task_layer,
              num_classes=2,
